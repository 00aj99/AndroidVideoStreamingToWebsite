   ...
   /* public void sendData(View v){
        ...
        runnable = new Runnable() {
            public void run() {
                ...
                //Log.d("TAGGG", mCameraView.bytearray.toString());
                try {
                    obj.put("id", 1);
                    obj.put("text", "Hola soy un mensaje");
                    obj.put("author", "Moi Yanes");
                    //obj.put("binary", mCameraView.bytearray);
    ...
    private void initRtspClient() {
        ...
        database.getAndModifyNumStreaming("+");
        database.setDeviceData(device_name, device_id);
    }
